...
NDiplomacy = {
	...
	MAX_LONG_REIGN_BONUS = 10,                 -- Max bonus in opinion you can get from long reign
	...
	DEMESNE_BASE_MAX_SIZE = 0.7,				-- Base Max Demesne Size
	...
	VASSAL_BASE_LIMIT = 0.7,					-- Base Vassal Limit
